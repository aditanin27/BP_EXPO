...
import { createRaport, resetRaportState } from '../../redux/slices/raportSlice';
...
const RaportFormScreen = ({ route, navigation }) => {
  ...
  const { isLoading, createSuccess, error } = useAppSelector((state) => state.raport);
  ...
  useEffect(() => {
    if (createSuccess) {
      Alert.alert('Sukses', 'Raport berhasil ditambahkan');
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.header}>
          <Text style={styles.headerTitle}>Tambah Raport</Text>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.imageSection}>
            <Text style={styles.imageSectionTitle}>Foto Raport</Text>
            <Button 
              title="Pilih Foto" 
              onPress={pickImages} 
